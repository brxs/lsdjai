...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"type": "set_style", "prompt_a": "funk"}, True),
        (
            {"type": "set_style", "prompt_a": "funk", "prompt_b": "techno", "mix": 0.4},
            True,
        ),
        ({"type": "set_style", "prompt_a": "funk", "bpm": 124}, True),
        ({"type": "set_style", "prompt_a": ""}, False),
        ({"type": "set_style", "prompt_a": "funk", "prompt_b": "  "}, False),
        ({"type": "set_style", "prompt_a": "funk", "mix": 1.5}, False),
        ({"type": "set_style", "prompt_a": "funk", "mix": "loud"}, False),
        ({"type": "set_style", "prompt_a": "funk", "bpm": 1000}, False),
        ({"type": "set_style", "prompt_a": "funk", "bpm": 124.5}, False),
